...
INSERT INTO tweets(text,timestamp,author) VALUES ('Soufflé tiramisu cake muffin tootsie roll bonbon brownie. Muffin biscuit chocolate cake macaroon sweet danish muffin sweet soufflé. Donut macaroon chupa chups.','2020-05-09 07:34:24','Donald Trump');
...
INSERT INTO tweets(text,timestamp,author) VALUES ('Tiramisu liquorice cookie jujubes. Bear claw topping oat cake jelly beans cupcake bear claw toffee bonbon. Lollipop pudding oat cake marshmallow gummi bears.','2020-05-09 07:34:54','Postman');
...
INSERT INTO tweets(text,timestamp,author) VALUES ('Pudding icing fruitcake carrot cake pudding pudding tootsie roll. Gingerbread candy icing chocolate cake.','2020-05-09 07:55:04','Donald Trump');
INSERT INTO tweets(text,timestamp,author) VALUES ('Jelly cookie icing soufflé chocolate sweet roll caramels. Bear claw candy canes pastry cotton candy lollipop jelly tootsie roll tart.','2020-05-012 07:34:04','Postman');
...
INSERT INTO tweets(text,timestamp,author) VALUES ('Bonbon caramels ice cream marzipan chupa chups oat cake. Tiramisu brownie cupcake pie pie jujubes chocolate cake cheesecake chocolate cake.','2020-08-09 07:34:04','Donald Trump');
INSERT INTO tweets(text,timestamp,author) VALUES ('Gummi bears donut cake jelly lemon drops liquorice sweet brownie chocolate bar. Gummies cheesecake candy tiramisu sweet roll sweet roll icing pastry. Liquorice pie jelly pastry.','2020-05-09 09:34:04','Donald Trump');
...
INSERT INTO tweets(text,timestamp,author) VALUES ('Cupcake chupa chups sweet. Muffin gummi bears cake oat cake chocolate.','2020-05-09 12:34:04','Joe Biden');
INSERT INTO tweets(text,timestamp,author) VALUES ('Cake toffee chocolate cake gummies candy. Cotton candy pie sugar plum cupcake jelly beans sesame snaps sugar plum.','2020-09-09 11:34:04','Joe Biden');
...
INSERT INTO tweets(text,timestamp,author) VALUES ('Dragée pastry cotton candy dragée jujubes jelly beans. Muffin sugar plum topping powder.','2020-05-09 07:12:04','Donald Trump');
...
INSERT INTO tweets(text,timestamp,author) VALUES ('Deadlights jack lad schooner scallywag dance the hempen jig carouser broadside cable strike colors.','2020-05-09 07:39:04','Postman');
...
INSERT INTO tweets(text,timestamp,author) VALUES ('Belay yo-ho-ho keelhaul squiffy black spot yardarm spyglass sheet transom heave to.','2020-05-09 07:44:04','Joe Biden');
...
INSERT INTO tweets(text,timestamp,author) VALUES ('ase shot Shiver me timbers gangplank crack Jennys tea cup ballast Blimey lee snow crows nest rutters.','2020-05-09 06:34:04','Postman');
...
INSERT INTO tweets(text,timestamp,author) VALUES ('Cheesy feet blue castello jarlsberg. Emmental cream cheese blue castello lancashire say cheese cheesy grin manchego fromage.','2020-02-09 07:34:04','Postman');
INSERT INTO tweets(text,timestamp,author) VALUES ('Goat camembert de normandie jarlsberg taleggio red leicester pecorino stilton the big cheese. Cauliflower cheese goat.','2020-03-09 11:36:04','Postman');
INSERT INTO tweets(text,timestamp,author) VALUES ('Chalk and cheese danish fontina macaroni cheese cauliflower cheese roquefort pepper jack cheeseburger rubber cheese.','2020-05-09 01:34:04','Donald Trump');
INSERT INTO tweets(text,timestamp,author) VALUES ('Who moved my cheese boursin cheesy feet. ','2020-05-09 07:34:24','Joe Biden');
